...
internal class PostgreSqlServerOnboardingClient : IDataSourceOnboardingClient
{
    ...
    public async Task<string> AddScanningManagedPrivateEndpointsAsync()
    {
        ...
        return await this.purviewAutomationClient.CreateManagedPrivateEndpointAsync(name: this.resource.Name, groupId: "postgresqlServer", resourceId: this.resourceId);
    }
